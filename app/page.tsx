...
export default function Home() {
  return (
    <main className={styles.main}>
      ...
      <p>
        We plan to create educational content and resources that will empower
        individuals to better understand and engage with NFT finance. This will
        include accessible information about how NFT finance works, its
        potential benefits, and best practices for using NFT financial tools. In
        addition to education, we will improve awareness of NFT finance by
        supporting non-profit, unbiased research. We believe that this will help
        to create a more comprehensive and objective understanding of NFT
        finance, while also improving its reputation and legitimacy. Finally, we
        recognize the need to improve connections between NFT finance
        participants and sources of liquidity. By facilitating deal flow and
        making it easier for users to access liquidity, we can help to create a
        more vibrant and active NFT finance ecosystem.
      </p>
      ...
      <p>
        In conclusion, we call upon all innovators and thinkers to join us in
        our mission to unlock the power of NFT finance and usher in a new era of
        innovation and progress in the digital economy. Together, we can shape a
        brighter future.
      </p>
    </main>
  );
